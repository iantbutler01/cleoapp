...
#[allow(dead_code)] // Kept for compatibility; browse_captures_with_count is now preferred
/// Browse captures with optional filters and pagination
pub async fn browse_captures<'e, E>(
    executor: E,
    user_id: i64,
    start_time: Option<DateTime<Utc>>,
    end_time: Option<DateTime<Utc>>,
...
#[allow(dead_code)] // Kept for compatibility; browse_captures_with_count is now preferred
/// Count captures matching filters (for pagination)
pub async fn count_captures<'e, E>(
    executor: E,
    user_id: i64,
    start_time: Option<DateTime<Utc>>,
    end_time: Option<DateTime<Utc>>,
